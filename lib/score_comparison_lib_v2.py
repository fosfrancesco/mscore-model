...
import operator
import mido
from lib.NoteTree_v2 import MonophonicScoreTrees, NoteNode, ScoreTrees_single_voice
...
def polyph_score_diff(score1,score2):
    ...
    scoreTrees1 = ScoreTrees_single_voice(score1)
    scoreTrees2 = ScoreTrees_single_voice(score2)
    total_operations = []
    total_cost = 0
